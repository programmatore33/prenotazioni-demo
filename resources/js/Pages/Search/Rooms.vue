      ...
      <div class="search-container">
        ...
        >
          <div class="flex justify-between w-full gap-4">
            <div>
              <p class="h3 font-poppins text-primary-800">Cerca stanze</p>
            </div>
            <div class="space-x-2">
              <BbButton
          ...
          <div class="flex mt-2 gap-4 items-center">
            ...
            <BbSwitch
              ...
              label="Includi stanze del passato"
              direction="auto"
        ...
        <div v-if="searchQuery && rooms" class="mt-2">
          <BbTable
            class="search-table"
            :columns="headers"
            :paginatedItems="rooms"
            :actions="false"
          >
            <template #name="{ item }">
              <button
                @click="goToday(item.date, item.am_or_pm)"
                type="button"
...
const headers = ref([
  {
    label: 'Nome',
    key: 'name',
    tdClass: '!text-primary-700 font-semibold'
  },
  {
    label: 'Tipologia',
    key: 'typology',
  ...
  },
  {
    label: 'Orario',
    key: 'am_or_pm',
    formatter: value => (value === 'AM' ? 'Mattina' : 'Pomeriggio')
  }
])
